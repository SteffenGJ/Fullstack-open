describe("Bloglist", function() {
  ...
  describe("when logged in", function() {
    ...
    it("a user can create new blogs", function() {
      cy.createBlog({ title: "Blog1", author: "Harry", url: "www.url.dk" });
      cy.contains("Blog1");
    });
    ...
    it("the blogs are sorted by number of likes", function() {
      cy.createBlog({ title: "Blog1", author: "Harry", url: "www.url.dk", likes: 24 });
      cy.createBlog({ title: "Blog2", author: "Potter", url: "www.url.dk", likes: 27 });
      cy.visit("http://localhost:3000");
